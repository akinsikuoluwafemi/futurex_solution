    ...
    return (
      <div className="containerr">
        ...
        <a
          ...
          href="https://www.amazon.com/Code-Book-Science-Secrecy-Cryptography/dp/0385495323/ref=sr_1_1?keywords=the+code+book&qid=1577289772&s=books&sr=1-1"
          target="_blank"
        >
          <figure class="container-figure">
            <img class="img" src={pic} alt="the code book image" />
        ...
        <a
          class="container-link"
          href="https://www.amazon.com/Thinking-Fast-Slow-Daniel-Kahneman/dp/0374275637/ref=tmm_hrd_swatch_0?_encoding=UTF8&qid=1577289975&sr=1-1"
          target="_blank"
        >
          <figure class="container-figure">
            <img class="img" src={pic} alt="Thinking fast and slow image" />
          </figure>
